...
// remove auto-redirecting for mistyped URLs
// see here http://www.mydigitallife.info/how-to-disable-wordpress-canonical-url-or-permalink-auto-redirect/
...
function getTweets($count) {
	...
	$oauth = array( 'screen_name' => 'neilcarpenter',
        			'count' => $count,
        			//'include_rts' => false,
	...
	$options = array( CURLOPT_HTTPHEADER => $header,
	                  ...
	                  CURLOPT_URL => $url . '?screen_name=neilcarpenter&count='.$count,
	                  //CURLOPT_URL => $url . '?screen_name=ikonarts&count='.$count.'&include_rts=false&exclude_replies=false',
